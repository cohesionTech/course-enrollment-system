   ...
   <div class="wrapper">
      ...
      <section>
         ...
         <div class="main-content">
            ...
            <div class="row">
               <div class="col-md-12">
               <c:url var="addAction" value="/term/add" ></c:url>
                        ...
                        <div class="panel-body">
                           <fieldset>
                              <div class="form-group">
                                 ...
                                 <div class="col-sm-4">
                                    <input type="text" name="tn" required="required" class="form-control">
                                 </div>
                              </div>
                           </fieldset>
						   ...
						   <fieldset>
                              <div class="form-group">
                                 ...
                                 <div class="col-sm-7">
                                    <input type="text" name="td" required="required" class="form-control">
                                 </div>
                              </div>
                           </fieldset>
