   ...
   <div class="wrapper">
      ...
      <section>
         ...
         <div class="main-content">
            ...
            <div class="row">
               <div class="col-md-12">
               <c:url var="addAction" value="/time/add" ></c:url>
                        ...
                        <div class="panel-body">
                           <fieldset>
                              <div class="form-group">
                                 ...
                                 <div class="col-sm-4">
                                    <input type="text" name="ts" required="required" class="form-control">
                                 </div>
                              </div>
                           </fieldset>
						   ...
						   <fieldset>
                              <div class="form-group">
                                 ...
                                 <div class="col-sm-7">
                                    <input type="text" name="tsd" required="required" class="form-control">
                                 </div>
                              </div>
                           </fieldset>
