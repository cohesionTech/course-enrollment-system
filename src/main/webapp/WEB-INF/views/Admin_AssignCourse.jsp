   ...
   <div class="wrapper">
      ...
      <section>
         ...
         <div class="main-content">
            ...
            <div class="row">
               <div class="col-md-12">
               <c:url var="addAction" value="/teachermap/assign" ></c:url>
               <c:forEach items="${teacherRecord}" var="r" >
                  <form action="${addAction}" data-parsley-validate="" novalidate="" class="form-horizontal" method="post">
                     ...
                     <div class="panel panel-default">
						...
						<fieldset>
							<div class="form-group">
								<label class="col-lg-2 control-label">Name:</label>
									<div class="col-lg-10">
										<p class="form-control-static">${r.t_Firstname } &nbsp; ${r.t_Lastname}</p>
						...
						<!--Hidden Fields  -->
						<input type="hidden" name="teid" value="${r.teid }">
						<input type="hidden" name="fn" value="${r.t_Firstname }">
						<input type="hidden" name="ln" value="${r.t_Lastname }">
						<input type="hidden" name="mobile" value="${r.t_Mobile }">
						<input type="hidden" name="ti" value="${r.t_TeachingInterest}">
