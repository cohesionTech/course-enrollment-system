   ...
   <div class="wrapper">
      ...
      <section>
         ...
         <div class="main-content">
            ...
            <div class="row">
               <div class="col-md-12">
               <c:url var="addAction" value="/course/update" ></c:url>
               <c:forEach items="${courseRecord}" var="c" >
								...
								<div class="col-sm-3">
									<select class="form-control m-b" name="deid">
										<c:forEach items="${departmentList}" var="r" >
											<option value="${r.deid }">${r.departmentName}</option>
	            						</c:forEach>
									</select>
								</div>
						...
						<input type="hidden" name="crid" value="${c.crid }">
                           ...
                           <fieldset>
                              <div class="form-group">
                                 ...
                                 <div class="col-sm-4">
                                    <input type="text" name="cn" required="required" class="form-control" value="${c.courseName}">
                                 </div>
                              </div>
                           </fieldset>
						   ...
						   <fieldset>
                              <div class="form-group">
                                 ...
                                 <div class="col-sm-7">
                                    <input type="text" name="cd" required="required" class="form-control" value="${c.courseDescription}">
                                 </div>
                              </div>
                           </fieldset>
                           ...
                           <fieldset>
						  	  <div class="form-group">
								 ...
								 <div class="col-sm-3">
									<select class="form-control m-b" name="lid">
										<c:forEach items="${locationList}" var="r" >
											<option value="${r.lid }">${r.lectureHall}</option>
	            						</c:forEach>
									</select>
								  </div>
							  </div>
						  ...
						  <fieldset>
						  	  <div class="form-group">
								 ...
								 <div class="col-sm-3">
									<select class="form-control m-b" name="tsid">
										<c:forEach items="${timeSlotList}" var="r" >
											<option value="${r.tsid }">${r.timeSlot}</option>
	            						</c:forEach>
									</select>
								  </div>
							  </div>
