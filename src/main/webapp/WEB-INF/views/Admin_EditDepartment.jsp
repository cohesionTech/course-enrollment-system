   ...
   <div class="wrapper">
      ...
      <section>
         ...
         <div class="main-content">
            ...
            <div class="row">
               <div class="col-md-12">
               <c:url var="addAction" value="/department/update" ></c:url>
               <c:forEach items="${departmentRecord}" var="d" >
                  <form action="${addAction}" data-parsley-validate="" novalidate="" class="form-horizontal" method="post">
                     ...
                     <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                                    ...
                                    <input type="hidden" name="did" value="${d.deid }">
                           ...
                           <fieldset>
                              <div class="form-group">
                                 ...
                                 <div class="col-sm-4">
                                    <input type="text" name="dn" required="required" class="form-control" value="${d.departmentName }">
                                 </div>
                              </div>
                           </fieldset>
						   ...
						   <fieldset>
                              <div class="form-group">
                                 <label class="col-sm-2 control-label">Department description*</label>
                                 <div class="col-sm-7">
                                    <input type="text" name="dd" required="required" class="form-control" value="${d.departmentDescription}">
                                 </div>
                              </div>
                           </fieldset>
