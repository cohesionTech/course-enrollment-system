   ...
   <div class="wrapper">
      ...
      <section>
         ...
         <div class="main-content">
            ...
            <div class="row">
               <div class="col-md-12">
               <c:url var="addAction" value="/term/update" ></c:url>
               <c:forEach items="${termRecord}" var="term" >
                  <form action="${addAction}" data-parsley-validate="" novalidate="" class="form-horizontal" method="post">
                     <!-- START panel-->
                     <div class="panel panel-default">
                        <div class="panel-heading">
                           <div class="panel-title">Term Details</div>
                        </div>
                        <div class="panel-body">
                           ...
                           <fieldset>
                              <div class="form-group">
                                 <label class="col-sm-2 control-label">Term name*</label>
                                 <div class="col-sm-4">
                                    <input type="text" name="tn" required="required" class="form-control" value="${term.termName }">
                                 </div>
                              </div>
                           </fieldset>
						   ...
						   <fieldset>
                              <div class="form-group">
                                 <label class="col-sm-2 control-label">Term description*</label>
                                 <div class="col-sm-7">
                                    <input type="text" name="td" required="required" class="form-control" value="${term.termDescription}">
                                 </div>
                              </div>
                           </fieldset>
