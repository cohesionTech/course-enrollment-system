   ...
   <div class="wrapper">
      ...
      <section>
         ...
         <div class="main-content">
            ...
            <div class="row">
               <div class="col-md-12">
               <c:url var="addAction" value="/time/update" ></c:url>
                  <c:forEach items="${timeSlotRecord}" var="r" >
                  <form action="${addAction}" data-parsley-validate="" novalidate="" class="form-horizontal" method="post">
                     <!-- START panel-->
                     <div class="panel panel-default">
                        <div class="panel-heading">
                           <div class="panel-title">Timing Details</div>
                        </div>
                        <div class="panel-body">
                        
                        <input type="hidden" name="tsid" value="${r.tsid }">
                        
                           <fieldset>
                              <div class="form-group">
                                 <label class="col-sm-2 control-label">Time-Slot*</label>
                                 <div class="col-sm-4">
                                    <input type="text" name="ts" value="${r.timeSlot}" required="required" class="form-control">
                                 </div>
                              </div>
                           </fieldset>
						   ...
						   <fieldset>
                              <div class="form-group">
                                 ...
                                 <div class="col-sm-7">
                                    <input type="text" name="tsd" value="${r.tsDescription}" required="required" class="form-control">
                                 </div>
                              </div>
                           </fieldset>
