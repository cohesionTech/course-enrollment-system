   ...
   <div class="wrapper">
      ...
      <section>
         ...
         <div class="main-content">
            <h3>View Teachers 
               <br>
               <small>Stored Teacher details</small>
            </h3>
            <!-- START row-->
                  ...
                  <div class="panel panel-default">
                     ...
                     <div class="panel-body">
                        <table id="datatable1" class="table table-striped table-hover">
                           ...
                           <tbody>
                           <c:forEach items="${teacherMapList}" var="r">
                              <tr class="gradeX">
                              	 <td>${r.tmap}</td>
								 <td>${r.teacher_FirstName}</td>
								 <td>${r.teacher_LastName}</td>
                                 <td>${r.teacher_Mobile}</td>
                                 <td>${r.teacher_TeachingInterest}</td>
                                 <td>${r.term.termName}</td>
                                 <td>${r.course.courseName}</td>
                                 <td><a href="<c:url value='/teachermap/edit?id=${r.tmap}' />">Change</a>/<a href="<c:url value='/teachermap/remove?id=${r.tmap}' />">Remove</a></td>
                              </tr>
                           </c:forEach>   
                           </tbody>
                        </table>
