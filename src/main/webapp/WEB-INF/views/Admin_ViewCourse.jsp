   ...
   <div class="wrapper">
      ...
      <section>
         ...
         <div class="main-content">
            <h3>View Course 
               <br>
               <small>Stored Course details</small>
            </h3>
            <!-- START row-->
                        ...
                        <table id="datatable1" class="table table-striped table-hover">
                           ...
                           <tbody>
                              ...
                              <tr class="gradeX">
                                 ...
                                 <td>${r.location.lectureHall}</td>
                                 <td>${r.timeSlot.timeSlot}</td>
                                 <td><a href="<c:url value='/course/edit?id=${r.crid}' />">Edit</a> / <a href="<c:url value='/course/remove?id=${r.crid}' />">Delete</a> </td>
                              </tr>
                          </c:forEach> 
