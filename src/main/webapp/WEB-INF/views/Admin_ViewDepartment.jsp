   ...
   <div class="wrapper">
      ...
      <section>
         ...
         <div class="main-content">
            <h3>View Department 
               <br>
               <small>Stored Department details</small>
            </h3>
            <!-- START row-->
                        ...
                        <table id="datatable1" class="table table-striped table-hover">
                           ...
                           <c:forEach items="${departmentList}" var="r">
                              <tr class="gradeX">
                                 ...
                                 <td>${r.departmentDescription}</td>
                                 <td><a href="<c:url value='/department/edit?id=${r.deid}' />">Edit</a> / <a href="<c:url value='/department/remove?id=${r.deid}' />">Delete</a> </td>
                              </tr>
                          </c:forEach> 
                           </tbody>
                        </table>
