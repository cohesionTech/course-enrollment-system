     ...
     <aside class="aside">
      ...
      <section>
         ...
         <div class="main-content">
            <h3>View Schedule 
               <br>
               <small>Course Location details</small>
            </h3>
            <!-- START row-->
                  ...
                  <div class="panel panel-default">
                     ...
                     <div class="panel-body">
                        <table id="datatable1" class="table table-striped table-hover">
                           ...
                           <tbody>
                           <c:forEach items="${locationList}" var="r" varStatus="loopCounter">
                              <tr class="gradeX">
                              	 <td><c:out value="${loopCounter.count}"></c:out></td>
                                 <td>${r.lectureHall}</td>
                                 <td>${r.lhDescription}</td>
                                 <td><a href="<c:url value='/location/edit?id=${r.lid}' />">Edit</a> / <a href="<c:url value='/location/remove?id=${r.lid}' />">Delete</a> </td>
                              </tr>
                            </c:forEach>  
                           </tbody>
                        </table>
