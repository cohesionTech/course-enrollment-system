   ...
   <div class="wrapper">
      ...
      <section>
         ...
         <div class="main-content">
            <h3>View Term 
               <br>
               <small>Stored Term details</small>
            </h3>
            <!-- START row-->
                  ...
                  <div class="panel panel-default">
                     ...
                     <div class="panel-body">
                        <table id="datatable1" class="table table-striped table-hover">
                           ...
                           <tbody>
                           <c:forEach items="${sessionScope.termList}" var="term"  varStatus="loopCounter">
                              ...
                              <tr class="gradeX">
                                 ...
                                 <td><a href="<c:url value='/term/edit?id=${term.tid}' />">Edit</a> / <a href="<c:url value='/term/remove?id=${term.tid}' />">Delete</a> </td>
