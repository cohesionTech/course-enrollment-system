     ...
     <aside class="aside">
      ...
      <section>
         ...
         <div class="main-content">
            <h3>View Time-Slots 
               <br>
               <small>Stored Timing details</small>
            </h3>
            <!-- START row-->
                  ...
                  <div class="panel panel-default">
                     ...
                     <div class="panel-body">
                        <table id="datatable1" class="table table-striped table-hover">
                           ...
                           <tbody>
                           <c:forEach items="${timeSlotList}" var="r"  varStatus="loopCounter">
                              ...
                              <tr class="gradeX">
                              	 ...
                              	 <td>${r.timeSlot }</td>
                                 <td>${r.tsDescription}</td>
                                 <td><a href="<c:url value='/time/edit?id=${r.tsid}' />">Edit</a> / <a href="<c:url value='/time/remove?id=${r.tsid}' />">Delete</a> </td>
