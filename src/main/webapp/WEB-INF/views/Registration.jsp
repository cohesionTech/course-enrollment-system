      ...
      <div class="col-lg-3 align-middle">
         ...
         <div data-toggle="play-animation" data-play="fadeIn" data-offset="0" class="panel panel-dark panel-flat">
            ...
            <div class="panel-body">
                  ...
                  <button type="submit" class="btn btn-block btn-success" onclick="window.location='${context}/sregistration'">Student</button>
				  </div>
				  <div style="float:right" class="col-lg-6">
				  <button type="submit" class="btn btn-block btn-warning" onclick="window.location='${context}/tregistration'">Teacher</button>
				  </div>
            </div>
         </div>
         <!-- END panel-->
