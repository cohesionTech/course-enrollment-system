					...
					<div class="panel-heading">Course Home</div>
						<div class="panel-body">
							<div class="panel panel-default">
								<div class="panel-heading">Enrolled Courses and More</div>
									<div class="panel-body">
										<div class="table-responsive table-bordered">
											...
											<table class="table">
												...
												<tbody>
												<c:forEach items="${enrollmentRecord}" var="r1" varStatus="loopCounter">
												<tr>
												<td><c:out value="${loopCounter.count}"></c:out></td>
												<td>${r1.course.courseName}</td>
												<td>${r1.course.location.lectureHall }</td>
												<td>${r1.course.timeSlot.timeSlot}</td>
												<td><button class="btn btn-oval btn-warning" type="button" onclick="window.location='${context}/student/dropCourse?id=${r.student.sid}'">Click to Drop</button></td>
												</tr>
												</c:forEach>
												</tbody>
											</table>
