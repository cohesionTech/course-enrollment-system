   ...
   <div class="wrapper">
      ...
      <section>
         ...
         <div class="main-content">
            ...
            <!-- END row-->
            <!-- START row-->
            <c:forEach items="${courseRecord}" var="r" >
            <c:forEach items="${sessionScope.studentSession}" var="st" >
            
            <div class="row">
               <div class="col-md-12">
               <c:url var="addAction" value="/student/enrollCourse" ></c:url>
						...
						<fieldset>
							<div class="form-group">
								<label class="col-lg-2 control-label">Term:</label>
									<div class="col-lg-10">
										<p class="form-control-static">${r.term.termName}</p>
									</div>
							</div>
						</fieldset>
						...
						<fieldset>
							<div class="form-group">
								<label class="col-lg-2 control-label">Course Name:</label>
									<div class="col-lg-10">
										<p class="form-control-static">${r.courseName}</p>
									</div>
							</div>
						</fieldset>
						...
						<fieldset>
							<div class="form-group">
								<label class="col-lg-2 control-label">Description:</label>
									<div class="col-lg-10">
										<p class="form-control-static">${r.courseDescription}</p>
									</div>
							</div>
						</fieldset>
						...
						<fieldset>
							<div class="form-group">
								<label class="col-lg-2 control-label" >Time:</label>
									<div class="col-lg-10">
										<p class="form-control-static">${r.timeSlot.timeSlot}</p>
									</div>
							</div>
						</fieldset>
						...
						<fieldset>
							<div class="form-group">
								<label class="col-lg-2 control-label">Location:</label>
									<div class="col-lg-10">
										<p class="form-control-static">${r.location.lectureHall}</p>
									</div>
							</div>
						</fieldset>
						
						<input type="hidden" name="term" value="${r.term.tid }">
						<input type="hidden" name="course" value="${r.crid }">
                        ...
                        <div class="panel-footer">
                           <div class="clearfix">
                              ...
                              <div class="pull-center">
                                 <center> <button type="submit" class="btn btn-primary">Enroll</button> <center>
                              </div>
                           </div>
                        </div>
                     </div>
