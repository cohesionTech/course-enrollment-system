         ...
         <div class="main-content">
            ...
            <div>
               <div style=" height:280px; width:250px; float:left" class = "panel panel-primary">
				   ...
				   <div style="height:50px; width:250px; float:left"><center><button class="mb-sm btn btn-inverse" type="button" onclick="window.location='${context}/student/edit?id=${r.sid}'">Edit Profile</button></center></div>
				   
               </div>
			   
			   <div style="border-style:solid;  height:500px; width:700px; float:left; margin-left:10px"  class = "panel panel-info ">
						...
						<fieldset>
							<div class="form-group">
								<label class="col-lg-2 control-label">First Name:</label>
									<div class="col-lg-10">
										<p class="form-control-static">${r.firstname}</p>
									</div>
							</div>
						</fieldset>
						...
						<fieldset>
							<div class="form-group">
								<label class="col-lg-2 control-label">Last Name:</label>
									<div class="col-lg-10">
										<p class="form-control-static">${r.lastname}</p>
									</div>
							</div>
						</fieldset>
						...
						<fieldset>
							<div class="form-group">
								<label class="col-lg-2 control-label" >Mobile:</label>
									<div class="col-lg-10">
										<p class="form-control-static">${r.mobile}</p>
									</div>
							</div>
						</fieldset>
						...
						<fieldset>
							<div class="form-group">
								<label class="col-lg-2 control-label">Major:</label>
									<div class="col-lg-10">
										<p class="form-control-static">${r.department.departmentName}</p>
									</div>
							</div>
						</fieldset>
