   ...
   <div class="wrapper">
      ...
      <section>
         ...
         <div class="main-content">
            ...
            <div class="row">
               <div class="col-md-12">
               <c:url var="addAction" value="/teacher/assignGrade" ></c:url>
               <c:forEach items="${enrollmentRecord}" var="r" >
                  <form action="${addAction}" data-parsley-validate="" novalidate="" class="form-horizontal" method="post">
                     ...
                     <div class="panel panel-default">
						...
						<fieldset>
							<div class="form-group">
								<label class="col-lg-2 control-label">Name:</label>
									<div class="col-lg-10">
										<p class="form-control-static">${r.student.firstname}&nbsp; ${r.student.lastname}</p>
						...
						<fieldset>
							<div class="form-group">
								<label class="col-lg-2 control-label" >Email:</label>
									<div class="col-lg-10">
										<p class="form-control-static">${r.student.email}</p>
									</div>
							</div>
						</fieldset>
						...
						<!--Hidden Fields  -->
						<input type="hidden" name="sid" value="${r.student.sid}">
						<input type="hidden" name="tid" value="${r.term.tid}">
						<input type="hidden" name="crid" value="${r.course.crid}">
                        </div>
