      ...
      <section>
         ...
         <div class="main-content">
            ...
            <div class="row">
               ...
               <c:url var="addAction" value="/teacher/update" ></c:url>
                        ...
                        <div class="panel-body">
                           <fieldset>
                              <div class="form-group">
                                 ...
                                 <div class="col-sm-4">
                                    <input type="text" name="fn" value="${r.t_Firstname}" required="required" class="form-control">
                                 </div>
                              </div>
                           </fieldset>
						   ...
						   <fieldset>
                              <div class="form-group">
                                 ...
                                 <div class="col-sm-4">
                                    <input type="text" name="ln" value="${r.t_Lastname}" required="required" class="form-control">
                                 </div>
                              </div>
                           </fieldset>
						   ...
						   <fieldset>
                              <div class="form-group">
                                 ...
                                 <div class="col-sm-7">
                                    <input type="text" name="addr" value="${r.t_Address}" required="required" class="form-control">
                                 </div>
                              </div>
                           </fieldset>
                           ...
                           <fieldset>
                              <div class="form-group">
                                 ...
                                 <div class="col-sm-6">
                                    <input type="email" name="email" value="${r.t_Email}" required="required" data-parsley-type="email" class="form-control">
                                 </div>
                              </div>
                           </fieldset>
						   ...
						   <fieldset>
                              <div class="form-group">
                                 ...
                                 <div class="col-sm-3">
									<input class="form-control" name="mobile" value="${r.t_Mobile}" type="text" required="required"  data-inputmask="'mask': '(999) 999-9999'" data-toggle="masked">
                                 </div>
                              </div>
                           </fieldset>
						   ...
						   <fieldset>
                              <div class="form-group">
                                 ...
                                 <div class="col-sm-4">
                                    <input type="text" name="ti" value="${r.t_TeachingInterest}" required="required" class="form-control">
                                 </div>
                              </div>
                           </fieldset>
