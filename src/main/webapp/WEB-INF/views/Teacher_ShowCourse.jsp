									...
									<div class="panel-body">
										<div class="table-responsive table-bordered">
											...
											<table class="table">
												...
												<td><button class="btn btn-oval btn-primary" type="button" onclick="window.location='${context}/teacher/showStudentList?crid=${r.course.crid}&tid=${r.term.tid}'">Click to Load</button></td>
												</tr>
												</c:forEach>
												</tbody>
											</table>
