                  ...
                  <div class="panel panel-default">
                     ...
                     <div class="panel-body">
                        <table id="datatable1" class="table table-striped table-hover">
                           ...
                           <tbody>
                           <c:forEach items="${gradeList}" var="r" varStatus="loopCounter">
                              <tr class="gradeX">
                                 ...
                                 <td>${r.grade}</td>
                                 <td><a href="<c:url value='/teacher/showGrade?id=${r.gid}' />">Change</a> / <a href="<c:url value='/student/remove?id=${r.student.sid}' />">Drop</a> </td>
                              </tr>
                           </c:forEach>   
                           </tbody>
                        </table>
